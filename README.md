* Made two seperate character controller scripts, one that uses horizontal and vertical and another that uses Mouse X and Mouse Y (I had to edit it in the project settings to make it work with IJKL
